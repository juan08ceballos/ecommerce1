                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="{{ route('order.index') }}">Checkout</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="o-card">
                                                    <div class="o-card__flex">
                                                        <div class="o-card__img-wrap">
                                                            ...
                                                            <img class="u-img-fluid" src="{{$product['product']->images[0]->url}}" alt=""></div>
                                                        <div class="o-card__info-wrap">
                                                            ...
                                                            <span class="o-card__quantity">Quantity x {{$product['amount']}}</span>

                                                            <span class="o-card__price">${{ $product['product']->price }}</span></div>
                                                    </div>

                                                    <a class="o-card__del far fa-trash-alt" href="{{ route('cart.edit',[$key]) }}"></a>
                                                </div>
                                                @endforeach
                                                ...
                                                <div class="o-summary__box">
                                                    <table class="o-summary__table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>GRAND TOTAL</td>
                                                                <input type="hidden" name="finalPrice" value="{{ $total + $iva + 5000 }}">
                                                    ...
                                                    <h1 class="checkout-f__h1">PAYMENT INFORMATION</h1>
                                                        ...
                                                        <div class="u-s-m-b-10">
                                                            ...
                                                            <div class="radio-box">
                                                                ...
                                                                <input type="radio" id="direct-bank-transfer" name="payment" value="crypto">
                                                                <div class="radio-box__state radio-box__state--primary">
    
                                                                    <label class="radio-box__label" for="direct-bank-transfer">Crypto Transfer</label></div>
                                                            </div>
                                                            <!--====== End - Radio Box ======-->
                                                        ...
                                                        <div class="u-s-m-b-10">
                                                            ...
                                                            <div class="radio-box">
                                                                ...
                                                                <input type="radio" id="pay-with-check" name="payment" value="pse">
                                                                <div class="radio-box__state radio-box__state--primary">
    
                                                                    <label class="radio-box__label" for="pay-with-check">Pay With PSE</label></div>
                                                            </div>
                                                            <!--====== End - Radio Box ======-->
                                                        ...
                                                        <div class="u-s-m-b-10">
                                                            ...
                                                            <div class="radio-box">
                                                                ...
                                                                <input type="radio" id="pay-with-card" name="payment" value="cc">
                                                                <div class="radio-box__state radio-box__state--primary">
