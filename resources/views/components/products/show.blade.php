                ...
                <div class="col-lg-7">
                    ...
                    <div class="pd-detail">
                        <div>
                            ...
                            <span class="pd-detail__name">{{ strtoupper($products->name) }}</span>
                        </div>
                        <div>
                        ...
                        <div class="u-s-m-b-15">
                            <div class="pd-detail__rating gl-rating-style">
                                ...
                                <span class="pd-detail__review u-s-m-l-4">
                                    ...
                                    <a data-click-scroll="#view-review">{{ count($products->views) }} Reviews</a></span>
                            </div>
                        </div>
                        <div class="u-s-m-b-15">
                            <div class="pd-detail__inline">

                                <span class="pd-detail__stock">{{ $products->stock }} in stock</span>
                            ...
                            <ul class="nav pd-tab__list">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" id="view-review" data-toggle="tab" href="#pd-rev">REVIEWS
                                        ...
                                        <span>({{ count($products->views) }})</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="pd-desc">
                                <div class="pd-tab__desc">
                                    ...
                                    <div class="u-s-m-b-30"><iframe src="{{ $products->video }}"
